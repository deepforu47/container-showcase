...
def home():
    ...
    <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 50px auto; padding: 30px; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); background-color: #f8fafc;">
        ...
        <p style="font-size: 16px;"><b>Container Hostname (ID):</b> <code style="background: #e2e8f0; padding: 2px 6px; border-radius: 4px;">{container_id}</code></p>
        ...
        <div style="background-color: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 8px; padding: 15px; margin: 20px 0;">
            <h3 style="color: #166534; margin-top: 0; margin-bottom: 10px;">🛡️ Security Best Practice: Non-Root User</h3>
            <p style="font-size: 14px; margin: 5px 0;"><b>Process UID/GID:</b> <code>{user_id} / {group_id}</code></p>
            <p style="font-size: 14px; margin: 5px 0; color: #166534;">Running securely as an unprivileged user inside the container!</p>
        </div>
        
        <hr style="border: 0; border-top: 1px solid #e2e8f0; margin: 20px 0;">
        <p style="color: #64748b; font-style: italic; font-size: 14px;">Hello from inside your completely isolated Docker container!</p>
    </div>
    """
